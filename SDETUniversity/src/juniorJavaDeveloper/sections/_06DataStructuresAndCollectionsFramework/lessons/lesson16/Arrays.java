package juniorJavaDeveloper.sections._06DataStructuresAndCollectionsFramework.lessons.lesson16;
...
public class Arrays {
	...
	public static void main(String[] args) {
		...
		System.out.println("The old fasioned way:");
		for (int i = 0; i < 5; i++) {
		...
		String [][] users = {
					...
					{"Rachel","Wallace","rw@testemail.com","9879874655"}
				};
