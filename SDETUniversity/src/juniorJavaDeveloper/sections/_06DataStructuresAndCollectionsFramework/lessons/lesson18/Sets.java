package juniorJavaDeveloper.sections._06DataStructuresAndCollectionsFramework.lessons.lesson18;
...
public class Sets {
	...
	public static void main(String[] args) {
		...
		// TreeSet - rearranges to natural (alphabetical/numerical) order
		...
		// What is the DIFFERENCE (animals but NOT farm animals - in one and NOT the other)
